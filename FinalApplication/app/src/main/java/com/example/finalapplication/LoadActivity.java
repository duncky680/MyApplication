...
import com.example.finalapplication.bean.UserInfo;
import com.example.finalapplication.database.UserDBHelper;
import com.example.finalapplication.util.DateUtil;
import com.example.finalapplication.util.ViewUtil;
...
public class LoadActivity extends AppCompatActivity implements View.OnClickListener, View.OnFocusChangeListener {
    ...
    // 初始化用户类型的下拉框
    private String[] typeArray = {"个人用户", "公司用户","18990016 韩东池"};
